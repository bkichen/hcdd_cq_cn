var img = {
	 ...
	 init:function(){
		...
		for(var i=0;i<img.imagebg_li.length;i++){
			...
			if(i!=0){
				img.small_pic_html.push("<li onclick='img.play("+i+")'><img src='"+img.imagebg_li[i].getAttribute("data-sPic")+"' width='144px' height='65px' /></li>");
				img.imagebg.getElementsByTagName("li")[i].style.display ="none";
			}else{
				img.small_pic_html.push("<li onclick='img.play("+i+")' class='currently'><img src='"+img.imagebg_li[i].getAttribute("data-sPic")+"' width='144px' height='65px' /></li>");
			}
