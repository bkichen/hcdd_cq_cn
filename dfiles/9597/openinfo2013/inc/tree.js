...
function drawFolder(leftSide)
{
	...
	doc.write("src='" + ImgDir + this.iconSrc+"'  width=16 height=15 align=left border=0 vspace=0 hspace=0 border=0>&nbsp;");
...
function drawItem(leftSide)
{
	...
	if(browserVersion == 2)
	{
		doc.write("<layer id=showname  visibility=hide>"+this.desc+"</layer>");
	}
	
	doc.write("<img id='itemIcon"+this.id+"' ");
	doc.write("src='" + ImgDir + this.iconSrc+"'  width=13 height=15 align=left border=0 vspace=0 hspace=0 border=0>&nbsp;");
	doc.write("<font color="+MenuTextColor+">" + this.desc + "</font></a>");
	doc.write("</table>");
